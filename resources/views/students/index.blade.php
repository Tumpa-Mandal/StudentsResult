        ...
        <div class="col-md-12">
            <div class="card-header">
                    ...
                    <div class="card-tools" style="position: absolute;right: 1rem;top: .5rem;">
                        <a class="btn btn-primary" href="{{ url('/subjects') }}">Subject<i class="fas fa-plus"></i></a>
                        <a class="btn btn-primary" href="{{ url('/students/create') }}">Add New <i class="fas fa-plus"></i></a>
                    </div>
